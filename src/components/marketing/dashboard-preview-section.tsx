...
export async function DashboardPreviewSection() {
  ...
  return (
    <section className="pb-20 pt-8 md:pb-28 md:pt-12">
      <MarketingContainer className="grid items-center gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-10">
        <div>
          <p className="marketing-section-label">{t("label")}</p>
          <h2 className="mt-3 text-4xl font-bold leading-[1.08] tracking-[-0.04em] text-navy-950 md:text-5xl">{t("title")}</h2>
        ...
        <div className="relative -mx-3 sm:mx-0">
          ...
          <Image
            ...
            className="relative h-auto w-full drop-shadow-[0_24px_40px_rgba(15,23,42,0.12)]"
          />
        </div>
      </MarketingContainer>
    </section>
