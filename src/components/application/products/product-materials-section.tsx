...
export function ProductMaterialsSection({
  ...
  return (
    <section aria-labelledby="materials-heading" className="mt-8 min-w-0 rounded-xl border border-slate-200 bg-slate-50/70 p-4 sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {canEdit && data !== null && !loadFailed ? (
          <details className="group relative">
            <summary className={summaryClassName}><ProductActionIcon name="add" />{labels.addMaterial}</summary>
                    ...
                    <td className="px-3 py-4">
                      <div className="flex flex-col items-start gap-2">
                        <details className="w-full">
                          <summary className={rowSummaryClassName}><ProductActionIcon name="edit" />{labels.editMaterial}</summary>
                          <div className="mt-3 rounded-lg border border-slate-200 bg-slate-50 p-4">
                            <MaterialForm data={data} material={material} labels={labels} detailHref={detailHref} />
                          </div>
                        </details>
                        <details className="w-full">
                          <summary className={removeSummaryClassName}><ProductActionIcon name="remove" />{labels.removeMaterial}</summary>
  ...
  return (
    <form ref={formRef} onSubmit={submit} aria-busy={pending} noValidate>
      ...
      <div className="mt-3 flex flex-wrap justify-end gap-3">
        ...
        <button type="submit" disabled={pending} aria-disabled={pending} className={primaryButtonClassName}><ProductActionIcon name="save" />{material === undefined ? labels.add : labels.save}</button>
      </div>
    </form>
  );
}
...
const summaryClassName = "inline-flex max-w-full items-center gap-2 whitespace-normal [overflow-wrap:anywhere] min-h-11 cursor-pointer list-none items-center justify-center rounded-lg bg-teal-700 px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:ring-offset-2";
const rowSummaryClassName = "inline-flex max-w-full items-center gap-2 whitespace-normal [overflow-wrap:anywhere] cursor-pointer list-none text-sm font-bold text-teal-800 underline-offset-4 hover:underline focus:outline-none focus:ring-2 focus:ring-teal-600";
const removeSummaryClassName = "inline-flex max-w-full items-center gap-2 whitespace-normal [overflow-wrap:anywhere] cursor-pointer list-none text-sm font-bold text-red-700 underline-offset-4 hover:underline focus:outline-none focus:ring-2 focus:ring-red-600";
const primaryButtonClassName = "inline-flex max-w-full items-center justify-center gap-2 whitespace-normal [overflow-wrap:anywhere] min-h-11 rounded-lg bg-teal-700 px-4 py-2.5 text-sm font-bold text-white focus:ring-2 focus:ring-teal-600 disabled:cursor-wait disabled:opacity-70";
const secondaryButtonClassName = "inline-flex max-w-full items-center justify-center gap-2 whitespace-normal [overflow-wrap:anywhere] min-h-11 rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-teal-600 disabled:opacity-70";
const dangerButtonClassName = "inline-flex max-w-full items-center justify-center gap-2 whitespace-normal [overflow-wrap:anywhere] min-h-11 rounded-lg bg-red-700 px-4 py-2.5 text-sm font-bold text-white focus:ring-2 focus:ring-red-600 disabled:cursor-wait disabled:opacity-70";
