...
import { ActivationForm } from "@/src/components/application/auth/activation-form";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "Auth.activation" });
...
export default async function ActivationPage({ params }: PageProps) {
  ...
  return <AuthShell brandLabel={t("brand")} title={t("activation.title")} description={t("activation.description")}><ActivationForm /></AuthShell>;
}
