import { ProductImageServerSection } from "@/src/components/application/products/image-server-section";
import { GtinServerSection } from "@/src/components/application/products/gtin-server-section";
